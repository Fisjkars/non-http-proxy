...
public class RequestEntity implements Serializable {
     ...
     */
    public RequestEntity(int index, byte[] requestResponse, byte[] original, String SrcIp, int SrcPort, String DstIP, int DstPort, String Direction, Long time, int bytes) {
        this.alt_id = index;
